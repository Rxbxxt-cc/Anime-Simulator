    ...
    function OrionLib:MakeNotification(NotificationConfig)
        spawn(function()
            ...
            TweenService:Create(NotificationFrame.Icon, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {ImageTransparency = 0.5}):Play()
    ...
    function OrionLib:MakeWindow(WindowConfig)
        ...
        local function LoadSequence()
            ...
            wait(2)
            TweenService:Create(LoadSequenceText, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 0.5}):Play()
            MainWindow.Visible = true
